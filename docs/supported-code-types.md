# Supported codes
This is the list of supported code types that can be generated by **bwip-js**, hence by this project.

Look also [here](https://github.com/bwipp/postscriptbarcode/wiki/Symbologies-Reference) for symbologies reference. This is from the BWIPP project.
